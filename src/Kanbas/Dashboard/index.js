          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <small className="text-muted text-truncate">
                ...
                {isFallStart(startDate) ? "Fall" : "Spring"} Semester Full Term
              </small>
            </p>
...
const CourseForm = ({ course, setCourse, addNewCourse, updateCourse }) => (
        ...
        <div className="my-5">
          <div className="list-group w-50">
            ...
            {courses.map((courseItem) => (
              <div className="list-group-item" key={courseItem._id}>
